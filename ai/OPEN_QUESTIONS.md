...
|---|---|---|---|---|
| OQ-001 | What is the independent verdict on extract PR #6, viz PR #5, and app PR #5? | Fable | OPEN | Source review at exact head SHAs; falsifying tests; per-finding verdicts in `REVIEW_LOG.md`. |
